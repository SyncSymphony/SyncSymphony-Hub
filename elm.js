...
{
	if (region.b3.aY === region.ch.aY)
	{
		return 'on line ' + region.b3.aY;
	}
	return 'on lines ' + region.b3.aY + ' through ' + region.ch.aY;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.dF, request.d$, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cl: fragment, co: host, cG: path, cI: port_, cO: protocol, cP: query};
	});
...
var $author$project$Material$defaultModel = {b7: $elm$core$Dict$empty, b9: $elm$core$Dict$empty, ca: $elm$core$Dict$empty, cd: $elm$core$Dict$empty, cg: $elm$core$Dict$empty, cj: $elm$core$Dict$empty, cp: $elm$core$Dict$empty, cx: $elm$core$Dict$empty, q: $elm$core$Dict$empty, cQ: $elm$core$Dict$empty, af: $elm$core$Dict$empty, b$: $elm$core$Dict$empty, cZ: $elm$core$Dict$empty, a9: $elm$core$Dict$empty, c2: $elm$core$Dict$empty, c4: $elm$core$Dict$empty, c8: $elm$core$Dict$empty, c9: $elm$core$Dict$empty};
...
var $author$project$Main$init = function (_v0) {
	return $author$project$Main$noCmd(
		{bv: $author$project$Material$defaultModel, U: '', a0: $elm$core$Maybe$Nothing, aF: 120, bc: 4});
};
...
var $author$project$Main$buildErrorMessage = function (httpError) {
	switch (httpError.$) {
		case 0:
			...
			return message;
		case 1:
			return 'Check that the hub is online';
		case 2:
			return 'Make sure you are on the Hub\'s WiFi network';
		case 3:
...
var $author$project$Main$HubResponse = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Main$hubURL = 'http://sync.symphony/hub';
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{di: false, dl: r.dl, ds: r.ds, cn: r.cn, dF: r.dF, b4: r.b4, da: r.da, d$: r.d$}));
};
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{dl: r.dl, ds: r.ds, cn: _List_Nil, dF: 'POST', b4: $elm$core$Maybe$Nothing, da: $elm$core$Maybe$Nothing, d$: r.d$});
};
var $elm$http$Http$stringPart = _Http_pair;
var $author$project$Main$messageHub = function (model) {
	return $elm$http$Http$post(
		{
			dl: $elm$http$Http$multipartBody(
				_List_fromArray(
					[
						A2(
			...
			ds: $elm$http$Http$expectString($author$project$Main$HubResponse),
			d$: $author$project$Main$hubURL
		});
};
...
var $author$project$Internal$Ripple$Model$defaultModel = {ar: 0, t: $author$project$Internal$Ripple$Model$Idle, bN: $elm$core$Maybe$Nothing, bq: false};
var $author$project$Internal$Button$Model$defaultModel = {af: $author$project$Internal$Ripple$Model$defaultModel};
...
var $author$project$Internal$Ripple$Implementation$normalizedEventCoords = F3(
	function (event, pageOffset, clientRect) {
		...
		var x = _v0.Z;
		var y = _v0._;
		var documentX = x + clientRect.Z;
		var documentY = x + clientRect._;
		var _v1 = event.dM;
		var pageX = _v1.cD;
		var pageY = _v1.cE;
		return {Z: pageX - documentX, _: pageY - documentY};
	});
var $author$project$Internal$Ripple$Implementation$fgTranslationCoords = F2(
	function (isUnbounded, _v0) {
		var frame = _v0.R;
		var activationEvent = _v0.ah;
		var windowPageOffset = _v0.dg;
		var wasActivatedByPointer = _v0.de;
		var maxDimension = A2($elm$core$Basics$max, frame.df, frame.c);
		...
		var startPoint = function () {
			...
			var x = _v1.Z;
			var y = _v1._;
			return {Z: x - (initialSize / 2), _: y - (initialSize / 2)};
		}();
		var endPoint = {Z: (frame.df - initialSize) / 2, _: (frame.c - initialSize) / 2};
		return {ci: endPoint, c_: startPoint};
	});
...
var $author$project$Internal$Ripple$Implementation$animateActivation = F4(
	function (isUnbounded, frame, windowPageOffset, activationEvent) {
		...
		var _v0 = A2(
			...
			isUnbounded,
			{ah: activationEvent, R: frame, de: wasActivatedByPointer, dg: windowPageOffset});
		var startPoint = _v0.c_;
		var endPoint = _v0.ci;
		var translateEnd = isUnbounded ? '' : ($elm$core$String$fromFloat(endPoint.Z) + ('px, ' + ($elm$core$String$fromFloat(endPoint._) + 'px')));
		var translateStart = isUnbounded ? '' : ($elm$core$String$fromFloat(startPoint.Z) + ('px, ' + ($elm$core$String$fromFloat(startPoint._) + 'px')));
		return {X: translateEnd, Y: translateStart};
	});
...
var $author$project$Internal$Ripple$Model$numbers = {dp: 225, dw: 150, dA: 0.6, dL: 10, c6: 300};
var $elm$core$Basics$pow = _Basics_pow;
var $elm$core$Basics$sqrt = _Basics_sqrt;
var $author$project$Internal$Ripple$Implementation$layoutInternal = F2(
	function (isUnbounded, frame) {
		var maxDim = A2($elm$core$Basics$max, frame.df, frame.c);
		var initialSize = $elm$core$Basics$floor(maxDim * $author$project$Internal$Ripple$Model$numbers.dA);
		var hypotenuse = $elm$core$Basics$sqrt(
			A2($elm$core$Basics$pow, frame.df, 2) + A2($elm$core$Basics$pow, frame.c, 2));
		var boundedRadius = hypotenuse + $author$project$Internal$Ripple$Model$numbers.dL;
		var maxRadius = isUnbounded ? maxDim : boundedRadius;
		var fgScale = maxRadius / initialSize;
		return {H: fgScale, I: initialSize};
	});
			...
			switch (_v0.a.$) {
				...
				case 8:
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								bN: $elm$core$Maybe$Just(clientRect)
							}),
						$elm$core$Platform$Cmd$none);
				case 2:
					if (!_v0.b.$) {
				...
				case 4:
					switch (_v0.b.$) {
						case 1:
							...
							var element = _v7.b;
							var activationEvent = _v0.b.a.ah;
							return _Utils_eq(activateData.aP.aQ, activationEvent.aQ) ? _Utils_Tuple2(
								_Utils_update(
									model,
								...
								A2(
									...
									$elm$core$Task$succeed(0))) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
						case 2:
							var _v9 = _v0.a;
				...
				case 3:
					if (_v0.a.b.$ === 1) {
						...
						var element = _v15.b.a.dr;
						var viewport = _v15.b.a.dd;
						var newAnimationCounter = model.ar + 1;
						var _v16 = A4($author$project$Internal$Ripple$Implementation$animateActivation, activateData.aV, element, viewport, activateData.aP);
						var translateStart = _v16.Y;
						var translateEnd = _v16.X;
						var _v17 = A2($author$project$Internal$Ripple$Implementation$layoutInternal, activateData.aV, element);
						var fgScale = _v17.H;
						var initialSize = _v17.I;
						var activatedData = {
							ah: activateData.aP,
							bK: false,
							bl: false,
							H: fgScale,
							R: {c: element.c, n: element.Z, f: element._, df: element.df},
							I: initialSize,
							X: translateEnd,
							Y: translateStart,
							b5: activateData.b5
						...
						return _Utils_Tuple2(
							...
							A2(
								...
								$elm$core$Process$sleep($author$project$Internal$Ripple$Model$numbers.dp)));
					}
				case 5:
					if (_v0.b.$ === 1) {
							...
							if (activatedData.bl) {
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											t: $author$project$Internal$Ripple$Model$Deactivated(activatedData)
										}),
									A2(
										$elm$core$Task$perform,
										function (_v19) {
										...
										$elm$core$Process$sleep($author$project$Internal$Ripple$Model$numbers.c6)));
							} else {
								...
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											t: $author$project$Internal$Ripple$Model$Activated(newActivatedData)
										}),
									$elm$core$Platform$Cmd$none);
							}
						} else {
...
var $author$project$Internal$Button$Implementation$update = F3(
	function (lift, msg, model) {
		if (!msg.$) {
			var msg_ = msg.a;
			var _v1 = A2($author$project$Internal$Ripple$Implementation$update, msg_, model.af);
...
var $author$project$Internal$Button$Implementation$react = A4($author$project$Internal$Component$react, $author$project$Internal$Button$Implementation$getSet.cm, $author$project$Internal$Button$Implementation$getSet.dS, $author$project$Internal$Msg$ButtonMsg, $author$project$Internal$Button$Implementation$update);
var $author$project$Internal$Msg$CheckboxMsg = F2(
	function (a, b) {
		return {$: 2, a: a, b: b};
	});
var $author$project$Internal$Checkbox$Model$defaultModel = {bi: $elm$core$Maybe$Nothing, dC: false, bt: $elm$core$Maybe$Nothing};
...
var $author$project$Internal$Checkbox$Implementation$react = A4($author$project$Internal$Component$react, $author$project$Internal$Checkbox$Implementation$getSet.cm, $author$project$Internal$Checkbox$Implementation$getSet.dS, $author$project$Internal$Msg$CheckboxMsg, $author$project$Internal$Checkbox$Implementation$update);
var $author$project$Internal$Msg$ChipMsg = F2(
	function (a, b) {
		return {$: 3, a: a, b: b};
	});
var $author$project$Internal$Chip$Model$defaultModel = {af: $author$project$Internal$Ripple$Model$defaultModel};
...
var $author$project$Internal$Chip$Implementation$react = A4($author$project$Internal$Component$react, $author$project$Internal$Chip$Implementation$getSet.cm, $author$project$Internal$Chip$Implementation$getSet.dS, $author$project$Internal$Msg$ChipMsg, $author$project$Internal$Chip$Implementation$update);
var $author$project$Internal$Msg$DialogMsg = F2(
	function (a, b) {
		return {$: 4, a: a, b: b};
	});
var $author$project$Internal$Dialog$Model$defaultModel = {aL: false, l: false};
...
var $author$project$Internal$Dialog$Implementation$react = A4($author$project$Internal$Component$react, $author$project$Internal$Dialog$Implementation$getSet.cm, $author$project$Internal$Dialog$Implementation$getSet.dS, $author$project$Internal$Msg$DialogMsg, $author$project$Internal$Dialog$Implementation$update);
var $author$project$Internal$Msg$DrawerMsg = F2(
	function (a, b) {
		return {$: 5, a: a, b: b};
	});
var $author$project$Internal$Drawer$Model$defaultModel = {aL: false, bj: false, l: false};
					...
					$elm$core$Maybe$Just(
						_Utils_update(
							model,
							{
								aL: false,
								bj: false,
								l: model.bj ? false : model.l
							})),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Internal$Drawer$Implementation$react = A4($author$project$Internal$Component$react, $author$project$Internal$Drawer$Implementation$getSet.cm, $author$project$Internal$Drawer$Implementation$getSet.dS, $author$project$Internal$Msg$DrawerMsg, $author$project$Internal$Drawer$Implementation$update);
...
var $author$project$Internal$Fab$Model$defaultModel = {af: $author$project$Internal$Ripple$Model$defaultModel};
...
var $author$project$Internal$Fab$Implementation$react = A4(
	...
	$author$project$Internal$Fab$Implementation$getSet.cm,
	$author$project$Internal$Fab$Implementation$getSet.dS,
...
var $author$project$Internal$IconButton$Model$defaultModel = {h: false, af: $author$project$Internal$Ripple$Model$defaultModel};
...
var $author$project$Internal$IconButton$Implementation$react = A4(
	$author$project$Internal$Component$react,
	$author$project$Internal$IconButton$Implementation$getSet.cm,
	$author$project$Internal$IconButton$Implementation$getSet.dS,
...
var $author$project$Internal$List$Model$defaultModel = {bq: $elm$core$Maybe$Nothing, a3: $elm$core$Dict$empty};
			...
			case 1:
				...
				var _v1 = A2(
					...
					A2(
						...
						A2($elm$core$Dict$get, index, model.a3)));
				var ripple = _v1.a;
				var effects = _v1.b;
				return _Utils_Tuple2(
					$elm$core$Maybe$Just(
						_Utils_update(
							model,
							{
								a3: A3($elm$core$Dict$insert, index, ripple, model.a3)
							})),
					A2(
						$elm$core$Platform$Cmd$map,
						A2(
...
var $author$project$Internal$List$Implementation$react = A4($author$project$Internal$Component$react, $author$project$Internal$List$Implementation$getSet.cm, $author$project$Internal$List$Implementation$getSet.dS, $author$project$Internal$Msg$ListMsg, $author$project$Internal$List$Implementation$update);
var $author$project$Internal$Msg$MenuMsg = F2(
	function (a, b) {
		return {$: 9, a: a, b: b};
	});
var $author$project$Internal$Menu$Model$defaultModel = {aL: false, aj: $elm$core$Maybe$Nothing, ax: $elm$core$Maybe$Nothing, bV: false, cx: $author$project$Internal$List$Model$defaultModel, l: false, C: $elm$core$Maybe$Nothing};
			...
			switch (msg.$) {
				...
				case 3:
					return (!model.l) ? _Utils_Tuple2(
						$elm$core$Maybe$Just(
							_Utils_update(
								model,
								{aL: true, aj: $elm$core$Maybe$Nothing, l: true})),
						$elm$core$Platform$Cmd$none) : _Utils_Tuple2($elm$core$Maybe$Nothing, $elm$core$Platform$Cmd$none);
				case 4:
					return model.l ? _Utils_Tuple2(
						$elm$core$Maybe$Just(
							_Utils_update(
								model,
								{aL: true, l: false})),
						A2($elm$core$Maybe$withDefault, false, model.C) ? A2(
							$author$project$Internal$Helpers$delayedCmd,
							70,
					...
					return _Utils_Tuple2(
						$elm$core$Maybe$Just(
							_Utils_update(
								model,
								{
									aj: $elm$core$Maybe$Just(geometry),
									C: $elm$core$Maybe$Just(config.C)
								})),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									...
									$elm$browser$Browser$Dom$focus(config.ck)),
									config.C ? A2(
									$author$project$Internal$Helpers$delayedCmd,
									120,
									lift($author$project$Internal$Menu$Model$AnimationEnd)) : A2(
				...
				case 2:
					return _Utils_Tuple2(
						...
						$elm$core$Platform$Cmd$none);
				case 7:
					if (model.l && (!_Utils_eq(model.aj, $elm$core$Maybe$Nothing))) {
						var $temp$lift = lift,
				...
				case 8:
					var shiftKey = msg.a.b1;
					var altKey = msg.a.bL;
					var ctrlKey = msg.a.bR;
					var metaKey = msg.a.bX;
					var key = msg.b;
					var keyCode = msg.c;
				...
				case 9:
					...
					return A2(
						...
						((isEscape || (isSpace || isEnter)) && ((!(altKey || (ctrlKey || metaKey))) && model.bV)) ? A3($author$project$Internal$Menu$Implementation$update, lift, $author$project$Internal$Menu$Model$Close, model) : _Utils_Tuple2($elm$core$Maybe$Nothing, $elm$core$Platform$Cmd$none));
				default:
					var msg_ = msg.a;
					return A2(
						$elm$core$Tuple$mapFirst,
...
var $author$project$Internal$Menu$Implementation$react = A4($author$project$Internal$Component$react, $author$project$Internal$Menu$Implementation$getSet.cm, $author$project$Internal$Menu$Implementation$getSet.dS, $author$project$Internal$Msg$MenuMsg, $author$project$Internal$Menu$Implementation$update);
var $author$project$Internal$Msg$RadioButtonMsg = F2(
	function (a, b) {
		return {$: 10, a: a, b: b};
	});
var $author$project$Internal$RadioButton$Model$defaultModel = {dC: false, af: $author$project$Internal$Ripple$Model$defaultModel};
...
var $author$project$Internal$RadioButton$Implementation$react = A4($author$project$Internal$Component$react, $author$project$Internal$RadioButton$Implementation$getSet.cm, $author$project$Internal$RadioButton$Implementation$getSet.dS, $author$project$Internal$Msg$RadioButtonMsg, $author$project$Internal$RadioButton$Implementation$update);
...
var $author$project$Internal$Ripple$Implementation$react = A4(
	$author$project$Internal$Component$react,
	$author$project$Internal$Ripple$Implementation$getSet.cm,
	$author$project$Internal$Ripple$Implementation$getSet.dS,
...
var $author$project$Internal$Select$Model$defaultModel = {bq: false, cs: false, q: $author$project$Internal$Menu$Model$defaultModel, af: $author$project$Internal$Ripple$Model$defaultModel};
...
var $author$project$Internal$Select$Implementation$react = A4($author$project$Internal$Component$react, $author$project$Internal$Select$Implementation$getSet.cm, $author$project$Internal$Select$Implementation$getSet.dS, $author$project$Internal$Msg$SelectMsg, $author$project$Internal$Select$Implementation$update);
var $author$project$Internal$Msg$SliderMsg = F2(
	function (a, b) {
		return {$: 13, a: a, b: b};
	});
var $author$project$Internal$Slider$Model$defaultModel = {E: false, aJ: $elm$core$Maybe$Nothing, bp: false, aj: $elm$core$Maybe$Nothing, aT: false, bB: false};
...
var $author$project$Internal$Slider$Implementation$valueFromPageX = F2(
	function (geometry, pageX) {
		var xPos = pageX - geometry.a2.n;
		var isRtl = false;
		var pctComplete = isRtl ? (1 - (xPos / geometry.a2.df)) : (xPos / geometry.a2.df);
		return geometry.e + (pctComplete * (geometry.j - geometry.e));
	});
	...
	function (lift, msg, model) {
		...
		while (true) {
			switch (msg.$) {
				...
				case 3:
					var pageX = msg.b.cD;
					var geometry = A2($elm$core$Maybe$withDefault, $author$project$Internal$Slider$Model$defaultGeometry, model.aj);
					...
					return _Utils_Tuple2(
						$elm$core$Maybe$Just(
							_Utils_update(
								...
								{
									E: true,
									aJ: $elm$core$Maybe$Just(activeValue),
									aT: true,
									bB: true
								})),
						$elm$core$Platform$Cmd$none);
				...
				default:
					return _Utils_Tuple2(
						$elm$core$Maybe$Just(
							_Utils_update(
								model,
								{E: false, aJ: $elm$core$Maybe$Nothing})),
						$elm$core$Platform$Cmd$none);
			}
		}
	});
var $author$project$Internal$Slider$Implementation$react = A4($author$project$Internal$Component$react, $author$project$Internal$Slider$Implementation$getSet.cm, $author$project$Internal$Slider$Implementation$getSet.dS, $author$project$Internal$Msg$SliderMsg, $author$project$Internal$Slider$Implementation$update);
...
var $author$project$Internal$Snackbar$Model$defaultModel = {l: false, bD: _List_Nil, aC: -1, bF: $author$project$Internal$Snackbar$Model$Inert};
...
var $author$project$Internal$Snackbar$Implementation$next = function (model) {
	return $elm$core$Platform$Cmd$map(
		$author$project$Internal$Snackbar$Model$Move(model.aC));
};
...
var $author$project$Internal$Snackbar$Implementation$tryDequeue = function (model) {
	var _v0 = _Utils_Tuple2(model.bF, model.bD);
	if ((!_v0.a.$) && _v0.b.b) {
		var _v1 = _v0.a;
		var _v2 = _v0.b;
		var c = _v2.a;
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					...
					bD: cs,
					aC: model.aC + 1,
					bF: $author$project$Internal$Snackbar$Model$Active(c)
				}),
			A2(
				$elm$core$Platform$Cmd$map,
				$author$project$Internal$Snackbar$Model$Move(model.aC + 1),
				A2($author$project$Internal$Helpers$delayedCmd, c.b4, 0)));
	} else {
		return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
	}
};
var $author$project$Internal$Snackbar$Implementation$move = F2(
	function (transition, model) {
		var _v0 = _Utils_Tuple2(model.bF, transition);
		if (_v0.b === 1) {
			if (_v0.a.$ === 1) {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							bF: $author$project$Internal$Snackbar$Model$Fading(contents)
						}),
					A2(
						$author$project$Internal$Snackbar$Implementation$next,
						model,
						A2($author$project$Internal$Helpers$delayedCmd, contents.bo, 0)));
			} else {
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			}
		} else {
			switch (_v0.a.$) {
				...
				default:
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{bF: $author$project$Internal$Snackbar$Model$Inert}),
						A2(
							$author$project$Internal$Snackbar$Implementation$next,
							model,
	...
	function (fwd, msg, model) {
		switch (msg.$) {
			case 0:
				...
				return _Utils_eq(seq, model.aC) ? A2(
					$elm$core$Tuple$mapSecond,
			...
			case 1:
				...
				return A2(
					...
					dismissOnAction ? A3(
						...
						fwd,
						A2($author$project$Internal$Snackbar$Model$Move, model.aC, 1),
...
var $author$project$Internal$Snackbar$Implementation$react = A4(
	$author$project$Internal$Component$react,
	$author$project$Internal$Snackbar$Implementation$getSet.cm,
	$author$project$Internal$Snackbar$Implementation$getSet.dS,
...
var $author$project$Internal$Switch$Model$defaultModel = {dC: false, af: $author$project$Internal$Ripple$Model$defaultModel};
...
var $author$project$Internal$Switch$Implementation$react = A4(
	$author$project$Internal$Component$react,
	$author$project$Internal$Switch$Implementation$getSet.cm,
	$author$project$Internal$Switch$Implementation$getSet.dS,
...
var $author$project$Internal$TabBar$Model$defaultModel = {o: 0, aj: $elm$core$Maybe$Nothing, a3: $elm$core$Dict$empty, dc: 0};
...
var $author$project$Internal$TabBar$Implementation$calculateScrollIncrement = F5(
	function (geometry, index, nextIndex, scrollPosition, barWidth) {
		...
		if (!maybe_next_tab.$) {
			...
			var relativeContentRight = next_tab.bQ - scrollPosition;
			var relativeContentLeft = (next_tab.bP - scrollPosition) - barWidth;
...
var $author$project$Internal$TabBar$Implementation$findAdjacentTabIndexClosestToEdge = F4(
	function (index, tab_, scrollPosition, barWidth) {
		var rootRight = tab_.az + tab_.A;
		var rootLeft = tab_.az;
	...
	function (lift, msg, model) {
		switch (msg.$) {
			...
			case 3:
				...
				return _Utils_Tuple2(
					function () {
						var tabBarWidth = geometry.c3.A;
						var scrollAreaWidth = geometry.cW.A;
						var isOverflowing = _Utils_cmp(tabBarWidth, scrollAreaWidth) > 0;
						var translateOffset = (!isOverflowing) ? 0 : model.dc;
						return $elm$core$Maybe$Just(
							_Utils_update(
								model,
								{
			...
			default:
				...
				var geometry = A2($elm$core$Maybe$withDefault, $author$project$Internal$TabBar$Model$defaultGeometry, model.aj);
				...
				var newScrollPosition = (!tab_index) ? 0 : (_Utils_eq(
					tab_index,
					$elm$core$List$length(geometry.ba) - 1) ? geometry.cW.A : (scrollPosition + scrollIncrement));
				return _Utils_Tuple2(
					$elm$core$Maybe$Just(
						_Utils_update(
							model,
...
var $author$project$Internal$TabBar$Implementation$react = A4($author$project$Internal$Component$react, $author$project$Internal$TabBar$Implementation$getSet.cm, $author$project$Internal$TabBar$Implementation$getSet.dS, $author$project$Internal$Msg$TabBarMsg, $author$project$Internal$TabBar$Implementation$update);
var $author$project$Internal$Msg$TextFieldMsg = F2(
	function (a, b) {
		return {$: 17, a: a, b: b};
	});
var $author$project$Internal$TextField$Model$defaultModel = {bq: false, aj: $elm$core$Maybe$Nothing, cs: false, bH: $elm$core$Maybe$Nothing};
...
var $author$project$Internal$TextField$Implementation$react = A4($author$project$Internal$Component$react, $author$project$Internal$TextField$Implementation$getSet.cm, $author$project$Internal$TextField$Implementation$getSet.dS, $author$project$Internal$Msg$TextFieldMsg, $author$project$Internal$TextField$Implementation$update);
var $author$project$Internal$Msg$TopAppBarMsg = F2(
	function (a, b) {
		return {$: 18, a: a, b: b};
	});
var $author$project$Internal$TopAppBar$Model$defaultModel = {P: 0, ct: true, aX: $elm$core$Maybe$Nothing, a3: $elm$core$Dict$empty, c0: $elm$core$Maybe$Nothing, D: $elm$core$Maybe$Nothing, bI: true};
		...
		function (topAppBarHeight) {
			...
			return partiallyShowing ? _Utils_Tuple2(
				_Utils_update(
					model,
					{bI: false}),
				true) : ((!model.bI) ? _Utils_Tuple2(
				_Utils_update(
					model,
					{bI: true}),
				true) : ((!_Utils_eq(model.ct, hasAnyPixelsOnscreen)) ? _Utils_Tuple2(
				_Utils_update(
					model,
					{ct: hasAnyPixelsOnscreen}),
			...
			return partiallyShowing ? A2(
				...
				function (topAppBarHeight) {
					...
					return _Utils_update(
						updatedModel,
						{
							c0: $elm$core$Maybe$Just(styleTop)
						});
				},
				updatedModel.D) : $elm$core$Maybe$Just(updatedModel);
		},
					...
					function (_v0) {
						...
						var updatedModel = _Utils_update(
							model,
							{
								...
								aX: $elm$core$Maybe$Just(currentScrollPosition)
							});
						return A2(
							$elm$core$Maybe$withDefault,
							updatedModel,
		...
		switch (msg.$) {
			case 0:
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						effects));
			case 1:
				var scrollPosition = msg.a.ao;
				var topAppBarHeight = msg.a.D;
				return _Utils_Tuple2(
					A2(
						...
						_Utils_update(
							model,
							{
								aX: $elm$core$Maybe$Just(scrollPosition),
								D: $elm$core$Maybe$Just(topAppBarHeight)
							})),
					$elm$core$Platform$Cmd$none);
			case 3:
				var scrollPosition = msg.a.ao;
			...
			default:
				...
				var updatedModel = (!_Utils_eq(
					...
					model.D)) ? _Utils_update(
					model,
					{
						P: currentAppBarOffsetTop,
						D: $elm$core$Maybe$Just(currentHeight),
						bI: false
					}) : model;
				return _Utils_Tuple2(
...
var $author$project$Internal$TopAppBar$Implementation$react = A4(
	$author$project$Internal$Component$react,
	$author$project$Internal$TopAppBar$Implementation$getSet.cm,
	$author$project$Internal$TopAppBar$Implementation$getSet.dS,
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				return _Utils_Tuple2(
					model,
					$author$project$Main$messageHub(model));
			case 2:
				if (!msg.a.$) {
					return $author$project$Main$noCmd(
						_Utils_update(
							...
							{
								U: '',
								a0: $elm$core$Maybe$Just(true)
							}));
				} else {
					var errortype = msg.a.a;
					return $author$project$Main$noCmd(
						_Utils_update(
							model,
							{
								U: $author$project$Main$buildErrorMessage(errortype),
								a0: $elm$core$Maybe$Just(false)
							}));
				}
			case 0:
				var newTempo = msg.a;
				var _v1 = $elm$core$String$toInt(newTempo);
				if (!_v1.$) {
					var validTempo = _v1.a;
					return $author$project$Main$noCmd(
						_Utils_update(
							model,
							{aF: validTempo}));
			...
			default:
				...
				if (!_v2.$) {
					var validNum = _v2.a;
					return (validNum > 0) ? $author$project$Main$noCmd(
						_Utils_update(
							model,
							{U: '', bc: validNum})) : $author$project$Main$noCmd(
						_Utils_update(
							model,
							{U: 'please enter a number greater than 0'}));
				} else {
					return $author$project$Main$noCmd(
						_Utils_update(
							model,
							{U: 'please enter a number', bc: 4}));
				}
		}
	});
var $author$project$Main$UpdateHub = {$: 1};
var $author$project$Main$UpdateTempo = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$UpdateTimeSig = function (a) {
	return {$: 4, a: a};
};
...
var $author$project$Styles$center_text = A2($elm$html$Html$Attributes$style, 'text-align', 'center');
...
var $author$project$Main$isOnline = function (status) {
	if (!status.$) {
		if (status.a) {
			return 'Is Online';
		} else {
	...
	return $author$project$Internal$Options$option(
		function (config) {
			return _Utils_update(
				config,
				{
					cB: _Utils_ap(config.cB, options)
				});
		});
};
	...
	function (event, decodeMessage) {
		return A2(
			...
			A2(
				...
				function (message) {
					return {cz: message, cK: false, c$: false};
				},
				decodeMessage));
	});
...
var $author$project$Styles$style_center = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'right', '50%'),
		A2($elm$html$Html$Attributes$style, 'bottom', '50%'),
		A2($elm$html$Html$Attributes$style, 'transform', 'translateX(50%) translateY(50%)'),
		...
		function (value, decoder, result) {
			return A2(
				...
				A2(
					...
					function (_v0) {
						var message = _v0.cz;
						var stopPropagation = _v0.c$;
						var preventDefault = _v0.cK;
						return {
							cz: A2($elm$core$List$cons, message, result.cz),
							cK: preventDefault || result.cK,
							c$: stopPropagation || result.c$
						};
					},
...
var $author$project$Internal$Dispatch$toAttributes = function (_v0) {
	...
	if (!_v1.$) {
		...
		return A2(
			...
			$elm$core$Dict$toList(config.ab));
	}
};
			...
			_Utils_ap(
				...
				_Utils_ap(
					...
					_Utils_ap(
						...
						_Utils_ap(
							summary.S,
							$author$project$Internal$Dispatch$toAttributes(summary.p))))));
		return all;
	});
		...
		switch (opt.$) {
			...
			case 2:
				...
				return _Utils_update(
					acc,
					{
						M: A2($elm$core$List$cons, x, acc.M)
					});
			case 3:
				var x = opt.a;
				return _Utils_update(
			...
			case 6:
				...
				return _Utils_update(
					acc,
					{
						p: A3($author$project$Internal$Dispatch$add, event, decoder, acc.p)
					});
			case 7:
				var lift = opt.a;
				return _Utils_update(
					acc,
					{
						p: A2($author$project$Internal$Dispatch$setLift, lift, acc.p)
					});
			default:
				return acc;
		}
...
var $author$project$Internal$Options$Summary = F6(
	function (classes, css, attrs, internal, dispatch, config) {
		return {M: attrs, N: classes, $7: config, O: css, p: dispatch, S: internal};
	});
var $author$project$Internal$Dispatch$defaultConfig = {ab: $elm$core$Dict$empty, bW: $elm$core$Maybe$Nothing};
...
var $author$project$Internal$Button$Implementation$defaultConfig = {as: false, aw: $elm$core$Maybe$Nothing, ay: $elm$core$Maybe$Nothing, bx: $elm$core$Maybe$Nothing, af: false, be: false};
...
var $author$project$Internal$Icon$Implementation$defaultConfig = {bw: 'i'};
...
var $author$project$Internal$Icon$Implementation$view = F2(
	function (options, name) {
		...
		var config = summary.$7;
		return A5(
			$author$project$Internal$Options$apply,
			summary,
			$elm$html$Html$node(config.bw),
			_List_fromArray(
				[
...
var $author$project$Internal$Ripple$Model$cssClasses = {dk: 'mdc-ripple-upgraded--background-focused', du: 'mdc-ripple-upgraded--foreground-activation', dv: 'mdc-ripple-upgraded--foreground-deactivation', dQ: 'mdc-ripple-upgraded', dZ: 'mdc-ripple-upgraded--unbounded'};
...
var $author$project$Internal$Ripple$Model$strings = {d0: '--mdc-ripple-fg-scale', d1: '--mdc-ripple-fg-size', d2: '--mdc-ripple-fg-translate-end', d3: '--mdc-ripple-fg-translate-start', d4: '--mdc-ripple-left', d5: '--mdc-ripple-top'};
var $author$project$Internal$Ripple$Implementation$cssVariables = F2(
	function (isUnbounded, _v0) {
		var fgScale = _v0.H;
		var translateStart = _v0.Y;
		var translateEnd = _v0.X;
		var initialSize = _v0.I;
		var frame = _v0.R;
		var unboundedCoords = isUnbounded ? {
			n: $elm$core$Basics$round((frame.df - initialSize) / 2),
		...
		var variables = $elm$core$List$concat(
			_List_fromArray(
				[
					_List_fromArray(
					[
						A2($author$project$Internal$Options$css, $author$project$Internal$Ripple$Model$strings.d1, fgSize),
						A2(
						$author$project$Internal$Options$css,
						$author$project$Internal$Ripple$Model$strings.d0,
					...
					[
						A2(
						$author$project$Internal$Options$css,
						$author$project$Internal$Ripple$Model$strings.d5,
						$elm$core$String$fromFloat(unboundedCoords.f) + 'px'),
						A2(
						$author$project$Internal$Options$css,
						$author$project$Internal$Ripple$Model$strings.d4,
						$elm$core$String$fromFloat(unboundedCoords.n) + 'px')
					]) : _List_fromArray(
					[
						A2($author$project$Internal$Options$css, $author$project$Internal$Ripple$Model$strings.d3, translateStart),
						A2($author$project$Internal$Options$css, $author$project$Internal$Ripple$Model$strings.d2, translateEnd)
					])
				]));
		return variables;
	});
...
var $author$project$Internal$Ripple$Model$Event = F2(
	function (eventType, pagePoint) {
		return {aQ: eventType, dM: pagePoint};
	});
...
var $author$project$Internal$Ripple$Implementation$decodeActivate = function (_v0) {
	var domId = _v0.cf;
	var isUnbounded = _v0.aV;
	var isActivated = _v0.cr;
	var previousActivationEvent = _v0.cL;
	var decodePagePoint = A3(
		$elm$json$Json$Decode$map2,
		F2(
			function (pageX, pageY) {
				return {cD: pageX, cE: pageY};
			}),
		A2(
			$elm$json$Json$Decode$at,
			_List_fromArray(
				...
				function (isSurfaceDisabled, isSameInteraction, event) {
					return (isActivated || (isSurfaceDisabled || isSameInteraction)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
						A2(
							...
							domId,
							{aP: event, dD: false, aV: isUnbounded, b5: false}));
				}),
...
var $author$project$Internal$Ripple$Model$ClientRect = F4(
	function (top, left, width, height) {
		return {c: height, n: left, f: top, df: width};
	});
		...
		var baseProperties = $author$project$Internal$Options$many(
			_List_fromArray(
				[
					...
					$author$project$Internal$Options$cs($author$project$Internal$Ripple$Model$cssClasses.dQ),
					A2(
					...
					model.bq ? $author$project$Internal$Options$cs($author$project$Internal$Ripple$Model$cssClasses.dk) : $author$project$Internal$Options$nop
				]));
			...
			case 0:
				...
				var cssVars = function () {
					...
					if (!_v1.$) {
						...
						var fgScale = _v2.H;
						var initialSize = _v2.I;
						return A2(
							$author$project$Internal$Ripple$Implementation$cssVariables,
							isUnbounded,
							{H: fgScale, R: clientRect, I: initialSize, X: '0px', Y: '0px'});
					} else {
						return _List_Nil;
					}
				}();
				...
				return {dB: interactionHandler, dN: properties};
			case 1:
				...
				var interactionHandler = $author$project$Internal$Options$many(
					_List_fromArray(
						[
							...
							activateHandler,
							deactivateHandler(activatedData.ah)
						]));
				var cssVars = A2(
					$author$project$Internal$Ripple$Implementation$cssVariables,
					isUnbounded,
					{H: activatedData.H, R: activatedData.R, I: activatedData.I, X: activatedData.X, Y: activatedData.Y});
				var properties = $author$project$Internal$Options$many(
					_List_fromArray(
						[
							baseProperties,
							$author$project$Internal$Options$many(cssVars),
							$author$project$Internal$Options$cs($author$project$Internal$Ripple$Model$cssClasses.du),
							A2(
							$author$project$Internal$Options$when,
							isUnbounded,
				...
				var properties = $author$project$Internal$Options$many(
					_List_fromArray(
						[
							baseProperties,
							$author$project$Internal$Options$many(cssVars),
							$author$project$Internal$Options$cs($author$project$Internal$Ripple$Model$cssClasses.dv)
						]));
				return {dB: interactionHandler, dN: properties};
		}
	});
var $author$project$Internal$Button$Implementation$button = F5(
	function (domId, lift, model, options, nodes) {
		...
		return A5(
			$author$project$Internal$Options$apply,
			summary,
			(!_Utils_eq(config.ay, $elm$core$Maybe$Nothing)) ? $elm$html$Html$a : $elm$html$Html$button,
			_List_fromArray(
				[
					$author$project$Internal$Options$cs('mdc-button'),
					A2(
					$author$project$Internal$Options$when,
					(!_Utils_eq(config.ay, $elm$core$Maybe$Nothing)) && (!config.as),
					$author$project$Internal$Options$attribute(
						$elm$html$Html$Attributes$href(
							A2($elm$core$Maybe$withDefault, '', config.ay)))),
					A2(
					$author$project$Internal$Options$when,
					config.as,
					$author$project$Internal$Options$attribute(
					...
					A3(
					$elm$core$Basics$composeL,
					$author$project$Internal$Options$when(config.af),
					$author$project$Internal$Options$many,
					_List_fromArray(
						[rippleInterface.dB, rippleInterface.dN])),
					A2(
					$elm$core$Maybe$withDefault,
					...
					A2(
						...
						A2(
							...
							$author$project$Internal$Button$Model$Click(config.af)),
						config.bx))
				]),
			_List_Nil,
...
var $author$project$Internal$Button$Implementation$view = F2(
	function (lift, index) {
		return A5(
			...
			$author$project$Internal$Button$Implementation$getSet.cm,
			...
			A2(
				...
				A2(
					$author$project$Internal$Options$recollect,
					{
						...
						$7: 0,
						O: _List_Nil,
						p: $author$project$Internal$Dispatch$clear(summary.p),
						S: _List_Nil
					},
					_Utils_ap(summary.$7.cB, options)),
				_List_Nil));
	});
...
var $author$project$Internal$TextField$Implementation$defaultConfig = {
	...
	dY: $elm$core$Maybe$Just('text'),
	bH: $elm$core$Maybe$Nothing
};
var $author$project$Internal$TextField$Model$defaultGeometry = {c: 0, cw: 0, df: 0};
...
var $author$project$Internal$TextField$Implementation$textField = F5(
	function (domId, lift, model, options, list) {
		...
		var config = summary.$7;
		var focused = model.bq && (!config.as);
		var isDirty = model.cs || A2(
			$elm$core$Maybe$withDefault,
			false,
			A2(
				$elm$core$Maybe$map,
		...
		var htmlLabel = A3(
			...
			_List_fromArray(
				[
					...
					$author$project$Internal$Options$for(config.bT)
				]),
			function () {
				var _v1 = config.bs;
				if (!_v1.$) {
		...
		var isInvalid = config.br || function () {
			var _v0 = config.aB;
			if (!_v0.$) {
				var pattern_ = _v0.a;
				return A2(
		...
		var leadingIcon_ = A3($author$project$Internal$TextField$Implementation$iconView, lift, config.bu, config.by);
		var trailingIcon_ = A3($author$project$Internal$TextField$Implementation$iconView, lift, config.be, config.bA);
		return A5(
			$author$project$Internal$Options$apply,
			summary,
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					A2(
					$author$project$Internal$Options$when,
					!_Utils_eq(config.bu, $elm$core$Maybe$Nothing),
					$author$project$Internal$Options$cs('mdc-text-field--with-leading-icon')),
					A2(
					$author$project$Internal$Options$when,
					!_Utils_eq(config.be, $elm$core$Maybe$Nothing),
			...
			_Utils_ap(
				...
				_List_fromArray(
					[
						...
						summary,
						config.v ? $elm$html$Html$textarea : $elm$html$Html$input,
						_List_fromArray(
							[
								$author$project$Internal$Options$cs('mdc-text-field__input'),
								$author$project$Internal$Options$id(config.bT),
								(config.aA && (!config.v)) ? A2(
								$author$project$Internal$Options$on,
								'focus',
								A2(
									$elm$json$Json$Decode$map,
								...
								_List_fromArray(
									[
										((!config.v) ? $elm$core$Maybe$Just : $elm$core$Basics$always($elm$core$Maybe$Nothing))(
										$elm$html$Html$Attributes$type_(
											A2($elm$core$Maybe$withDefault, 'text', config.dY))),
										(config.as ? $elm$core$Maybe$Just : $elm$core$Basics$always($elm$core$Maybe$Nothing))(
										$elm$html$Html$Attributes$disabled(true)),
										(config.bE ? $elm$core$Maybe$Just : $elm$core$Basics$always($elm$core$Maybe$Nothing))(
										A2(
											$elm$html$Html$Attributes$property,
											'required',
											$elm$json$Json$Encode$bool(true))),
										((!_Utils_eq(config.aB, $elm$core$Maybe$Nothing)) ? $elm$core$Maybe$Just : $elm$core$Basics$always($elm$core$Maybe$Nothing))(
										A2(
											$elm$html$Html$Attributes$property,
											'pattern',
											$elm$json$Json$Encode$string(
												A2($elm$core$Maybe$withDefault, '', config.aB)))),
										((!_Utils_eq(config.bH, $elm$core$Maybe$Nothing)) ? $elm$core$Maybe$Just : $elm$core$Basics$always($elm$core$Maybe$Nothing))(
										$elm$html$Html$Attributes$value(
											A2($elm$core$Maybe$withDefault, '', config.bH)))
									])),
								A2(
								$author$project$Internal$Options$when,
								!_Utils_eq(config.a1, $elm$core$Maybe$Nothing),
								$author$project$Internal$Options$attribute(
									$elm$html$Html$Attributes$placeholder(
										A2($elm$core$Maybe$withDefault, '', config.a1)))),
								A2(
								$author$project$Internal$Options$when,
								config.v && (!_Utils_eq(config.a4, $elm$core$Maybe$Nothing)),
								$author$project$Internal$Options$attribute(
									$elm$html$Html$Attributes$rows(
										A2($elm$core$Maybe$withDefault, 0, config.a4)))),
								A2(
								$author$project$Internal$Options$when,
								config.v && (!_Utils_eq(config.aO, $elm$core$Maybe$Nothing)),
								$author$project$Internal$Options$attribute(
									$elm$html$Html$Attributes$cols(
										A2($elm$core$Maybe$withDefault, 0, config.aO))))
							]),
						_List_Nil),
						((!config.aS) && ((!config.aA) && (!config.v))) ? htmlLabel : $elm$html$Html$text(''),
						trailingIcon_,
						((!config.aA) && (!config.v)) ? A3(
						$author$project$Internal$Options$styled,
						$elm$html$Html$div,
						_List_fromArray(
							[
...
var $author$project$Internal$TextField$Implementation$view = F4(
	function (lift, domId, store, options) {
		return A7(
			$author$project$Internal$Component$render,
			$author$project$Internal$TextField$Implementation$getSet.cm,
...
var $author$project$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		$author$project$Styles$style_center,
		_List_fromArray(
			[
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$elm$core$String$fromInt(model.aF) + 'bpm')
							])),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$max('240'),
								$elm$html$Html$Attributes$value(
								$elm$core$String$fromInt(model.aF)),
				...
				_List_fromArray(
					[
						...
						$author$project$Material$Options$onInput($author$project$Main$UpdateTimeSig),
						$author$project$Material$TextField$placeholder('4'),
						$author$project$Material$TextField$fullwidth,
						$author$project$Material$TextField$nativeControl(
						_List_fromArray(
							[
								$author$project$Material$Options$attribute($author$project$Styles$center_text)
							]))
					]),
				_List_Nil),
				A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Material$Options$onClick($author$project$Main$UpdateHub),
						$author$project$Material$Button$raised
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Update Hub')
					])),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Main$isOnline(model.a0))
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
